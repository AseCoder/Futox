module.exports = {
  ...
  async execute(msg, args, client, Discord) {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(`:small_orange_diamond: Account Creation Time: ${client.npm.moment(member.user.createdTimestamp).format('D.M.Y')}`, '\u200b')
      .addField(`:small_orange_diamond: Server Join Time: ${client.npm.moment(member.joinedTimestamp).format('D.M.Y')}`, '\u200b')
